...
class InfoParticipantes(Frame):
    def __init__(self, master=None):
        ...
        #JUGADOR 1
        self.lbl_jug1 = Label(self, text="Entrenador LALO")
        ...
        #JUGADOR 2
        self.lbl_jug2 = Label(self, text="Entrenador SANMA")
        ...
        self.lbl_jug3 = Label(self, text="Entrenador NACHO")
        ...
        #JUGADOR 4
        self.lbl_jug4 = Label(self, text="Entrenador JUANO")
